...
const BuyersAndSellers = () => {
  return (
    <div className="bg-gray-50 rounded-md p-8">
      <h1 className="font-thin text-3xl text-center capitalize ">Be come an agent <br /> </h1>
      <h1 className="font-bold text-3xl text-center text-pink-600 uppercase">Buyers And Sellers </h1>
