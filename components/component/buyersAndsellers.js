  ...
  return (
    <div className="bg-gray-50 rounded-md p-8">
      ...
      <div className="flex flex-col md:flex-row space-x-4 lg:space-y-10 space-y-4 text-center ">
        ...
        <div>
          {" "}
          <h1 className="font-bold capitalize text-center text-base">Strong protection  <FingerPrintIcon className="h-8 w-8 inline-flex text-red-600 m-1" /> </h1>
          nulla tempor voluptate sunt reprehenderit. Fugiat commodo voluptate
          cupidatat velit ex cillum. Veniam minim commodo nulla nostrud cillum
        </div>
        <div>
          {" "}
          <h1 className="font-bold capitalize text-center text-base">Professional expertise  <BadgeCheckIcon className="h-8 w-8 text-green-600 inline-flex" /> </h1>
          nulla tempor voluptate sunt reprehenderit. Fugiat commodo voluptate
          cupidatat velit ex cillum. Veniam minim commodo nulla nostrud cillum
        </div>
        <div className="">
          {" "} <h1 className="font-bold capitalize text-center text-base">24/7 quality products  <GlobeIcon className="h-8 w-8 text-blue-600 inline-flex " /> </h1> 
          nulla tempor voluptate sunt reprehenderit. Fugiat commodo voluptate
          cupidatat velit ex cillum. Veniam minim commodo nulla nostrud cillum
        </div>
      </div>
